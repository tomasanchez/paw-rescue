...
public abstract class Controller {
  ...
  /**
   * This method is called upon initialization of the View. The controller can perform its internal
   * setup in this hook. It is only called once per View instance, unlike the onBeforeRendering and
   * onAfterRendering hooks.
   */
  ...
  /**
   * 
   * This method is called every time the View is rendered, After-after filters are evaluated the
   * after the after-filters. It can be used to apply the last changes to the Model after the
   * Renderer has finished.
   * 
   * @param request the spark HTTP request object
   * @param response the spark HTTP response object
   */
