...
public class RescatistaTest {
  ...
  /*
   * @Test public void SeInformaUnaMascotaEncontradaPorUnaPersona() {//mofificar Persona persona =
   * new Persona("Lucia","Gomez",new Documento(TipoDocumento.DNI,15632659),
   * LocalDate.now(),contacto()); Rescatista rescatistaGato = crearRescatista(persona,
   * gatoEncontrado()); AdministracionUsers administracionUsers = new AdministracionUsers();
  ...
  // fotos.add("foto1");
  // return new MascotaEncontrada(fotos, "Tamaño grande y de pelo corto",
  // new Coordenada("df52", "54gn"), LocalDate.now(), 4523);
  // }

  // MascotaEncontrada perroEncontrado() {
  // List<String> fotos = new ArrayList<>();
  // fotos.add("foto1");
  // return new MascotaEncontrada(fotos, "Tamaño chico y pelo corto", new Coordenada("jf72",
  // "89pn"),
  // LocalDate.now(), 8965);
  // }
